...
<body>
    <section id="page-hero" class="section section__inverse justify-content-center pt-6 pb-4 pb-lg-5 pb-xl-6">
        <div class="bg bg-img position-absolute" data-bg-img=".img">
            <img src="../../img/contact_wallpaper.jpg" class="img" alt="Image" />
        </div>
            ...
            <div class="row text-center">
                ...
                <div class="col-md-3">
                    <a href="https://api.whatsapp.com/send?phone=83195333">
                        <span class="fa-stack fa-4x">
                            <img src="../../img/WhatsApp.png" class="img" alt="Image" width="180" />
                        </span>
                ...
                <div class="col-md-3">
                    <a href="https://www.youtube.com/channel/UCjQ7pvR-L9Kh8SGJPBQ0mIw">
                        <span class="fa-stack fa-4x">
                            <img src="../../img/Youtube.png" class="img" alt="Image" width="100" />
                        </span>
