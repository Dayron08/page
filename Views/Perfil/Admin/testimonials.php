...
<section id="page-hero" class="section section__inverse justify-content-center pt-6 pb-4 pb-lg-5 pb-xl-6">
    ...
    <div class="container-xl position-relative section-content text-center py-4">
        <h2 class="display-5 text-white mt-3 mt-lg-4">Testimonios</h2>

        <p class="lead mb-4 mb-lg-5">Experiencias que las personas han pasado con nosotros</p>
...
<section id="testimonials-1" class="section pb-6 mt-n4 mt-lg-n5 mt-xl-n6">
    ...
    <div class="container-xl position-relative h-100">
        ...
        <p class="text-light">
            <a class="btn btn-danger rounded-pill shadow-none me-2 px-4 fw-bold " href="#" id=""><i
