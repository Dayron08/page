  ...
  <section id="see-how-4" class="section py-5 py-lg-6">
      ...
      <div class="container-xl position-relative">
            <div class="container">
                ...
                <h1 class="text-center mb-5 fs-1 text-dark">Disponibilidad en <span class="text-primary">todas</span> las plataformas</h1>
                </div>
      ...
      <div class="container-xl position-relative h-900">
        ...
        <div class="row center gx-0">
          <div id="searchbox-2Searchbox" class="searchbox position-relative col-6 col-lg- pb-5">
            ...
            <a class="form-options-backdrop modal-backdrop collapsed" data-bs-toggle="collapse" href="#searchbox-2FormOptionsCollapse" role="button" aria-expanded="false" aria-controls="searchbox-2FormOptionsCollapse"></a>
