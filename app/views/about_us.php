...
<section id="page-hero" class="section section__inverse justify-content-center pt-6 pb-4 pb-lg-5 pb-xl-6">
    <div class="bg bg-img position-absolute" data-bg-img=".img"><img src="../../web/img/bible_picture.jpg" alt=""></div>
...
<section id="map" class="section mt-n4 mt-lg-n5 mt-xl-n6 vh-75" style="margin-bottom: 5%;">
    ...
    <div class="container-xl position-relative px-0 zi-20 h-100 overflow-hidden rounded">
        ...
        <h2 class="fs-3 section-title mb-3" style="text-align:center;">Nuestra Ubicaci&oacute;n</h2>
        <div class="mapouter">
