    ...
    <div class="container-xl position-relative h-100">
        <div class="row py-5 py-lg-6">
            <div class="col-12 col-md-6">
                ...
                <p class="lead me-lg-3 text-light mb-5">Pacto de vida es una Iglesia Cristiana biblica en su naturaleza,
                    aut&oacute;noma en su gobierno. Desde el principio es una congregaci&oacute;n de gente c&aacute;lida
                    y amigable que se re&uacute;ne para adorar al Se&ntilde;or</p>
...
<section id="cities-grid-2" class="section py-5 py-lg-6">
    ...
    <div class="container-xl position-relative h-100">
        <header class="section-header mb-5">
            <h2 class="fs-3 text-center section-title mb-3">Discover by Cities</h2>

            <p class="lead text-center mb-0 o-75">Complete neighbourhoud insight to help you start your search for home.
            </p>
        </header>
        <!-- /.section-header mb-5 -->
            ...
            <div class="col-12 col-lg-6 col-xl-6">
                <div class="position-relative expand-w h-100 o-75">
                    <div class="bg bg-img position-absolute" data-bg-img=".img">
                        <img src="../assets/img/" class="img" alt="Image" />
...
<section id="testimonials-swiper-1" class="section py-5 py-lg-6">
    ...
    <div class="container-xl position-relative">
        <header class="section-header mb-5">
            <h2 class="fs-3 section-title mb-3">Testimonial</h2>

            <p class="leadmb-0 o-75">What our lovely customer said about us</p>
        </header>
        <!-- /.section-header mb-5 -->
    </div>
    <!-- /.container-xl position-relative -->
    ...
    <div class="swiper-container with-pagination">
                            ...
                            <div class="col-12 col-md d-flex align-items-stretch">
                                <figure class="card testimonial h-100 text-start bg-transparent mb-0">
                                    <blockquote
                                        ...
                                        <div class="img px-3 px-lg-4">
                                            <img src="http://assets.coolorize.com/avatar/256x256/photo-1428931996691-a5108d4cdbf5.jpg"
                                                class="img rounded-circle" alt="Image" />
                                        </div>
                                    </blockquote>
                                </figure>
                            ...
                            <div class="col-6 col-md d-flex align-items-stretch">
                                <figure class="card testimonial h-100 text-start bg-transparent mb-0">
                                    <blockquote
                                        ...
                                        <div class="img px-3 px-lg-4">
                                            <img src="http://assets.coolorize.com/avatar/256x256/photo-1429114753120-0733a750d6c1.jpg"
                                                class="img rounded-circle" alt="Image" />
                                        </div>
                                    </blockquote>
                                </figure>
                            ...
                            <div class="col-6 col-md d-flex align-items-stretch">
                                <figure class="card testimonial h-100 text-start bg-transparent mb-0">
                                    <blockquote
                                        ...
                                        <div class="img px-3 px-lg-4">
                                            <img src="http://assets.coolorize.com/avatar/256x256/photo-1443381301867-5a36ffaafc42.jpg"
                                                class="img rounded-circle" alt="Image" />
                                        </div>
                                    </blockquote>
                                </figure>
                                ...
                                <figure class="card testimonial h-100 text-start bg-transparent mb-0">
                                    <blockquote
                                        ...
                                        <p class="text-secondary text-decoration-none fs-sm mt-auto mb-3 o-75">
                                            &mdash;<span class="fw-bold"> John Doe</span> - IT Profesional</p>
                                        <div class="img px-3 px-lg-4">
                                            <img src="http://assets.coolorize.com/avatar/256x256/photo-1445076129285-0f73155f2d3c.jpg"
                                                class="img rounded-circle" alt="Image" />
                                        </div>
                                    </blockquote>
                                </figure>
                                ...
                                <figure class="card testimonial h-100 text-start bg-transparent mb-0">
                                    <blockquote
                                        ...
                                        <p class="text-secondary text-decoration-none fs-sm mt-auto mb-3 o-75">
                                            &mdash;<span class="fw-bold"> John Doe</span> - Sales Representative</p>
                                        <div class="img px-3 px-lg-4">
                                            <img src="http://assets.coolorize.com/avatar/256x256/photo-1458173127669-917921c1c662.jpg"
                                                class="img rounded-circle" alt="Image" />
                                        </div>
                                    </blockquote>
                                </figure>
        ...
        <div class="swiper-pagination-container container-xl">
            <div class="d-flex flex-row justify-content-start">
                ...
                <a href="http://html.coolorize.com/discoverize/classic/testimonials-1.html"
                    class="btn btn-link btn-sm btn-more text-uppercase fw-bold shadow-none o-50 o-100-hover ms-3 trans-base px-0">All
                    Testimonials<i class="fas fa-long-arrow-alt-right"></i></a>
            </div>
        </div>
    </div>
...
<section id="searchbox-2" class="section bg-dark py-5 py-lg-6">
    <div class="bg bg-img position-absolute o-75 bg-white" data-bg-img=".img">
        <img src="../assets/img/hero-bg-3000.jpg" class="img" alt="Image" />

        <div class="overlay bg-dark position-absolute o-25"></div>
    </div>
    <!-- /.bg bg-img position-absolute o-75 bg-white -->

    <div class="container-xl position-relative h-100">
        <h3 class="visually-hidden">Discover Your Dream House</h3>

        <div class="row gx-0">
            <div id="searchbox-2Searchbox" class="searchbox position-relative col-12 col-lg-4 pb-5">
                ...
                <form action="#" class="searchbox-form position-relative w-100">
                    ...
                    <div class="position-relative pt-4 px-4">
                        ...
                        <div class="mb-3 position-relative">
                            <input type="text" class="form-control form-control shadow-none py-2"
                                placeholder="Address, Country, City or Postal Code"
                                data-show-bs-collapse-id="#searchbox-2FormOptionsCollapse"
                                data-scroll-to="#searchBox" />
                        </div>
                        <!-- /.mb-3 position-relative -->

                        <div class="mb-3 position-relative d-flex flex-column">
                            <label class="form-label text-secondary my-1"><small>Property Category</small></label>
                            <div class="btn-group" role="group">
                                <input type="radio" class="btn-check" name="searchbox-2searchCategory"
                                    id="searchbox-2searchCategory_sell" checked />
                                <label class="btn btn-outline-primary btn-default shadow-none fw-bold"
                                    for="searchbox-2searchCategory_sell"><i
                                        class="fas fa-check"></i>For&nbsp;Sale</label>
                                <input type="radio" class="btn-check" name="searchbox-2searchCategory"
                                    id="searchbox-2searchCategory_rent" />
                                <label class="btn btn-outline-primary btn-default shadow-none fw-bold"
                                    for="searchbox-2searchCategory_rent"><i
                        ...
                        <div class="mb-3 position-relative d-flex flex-column">
                            <label class="form-label text-secondary my-1"><small>Property Type</small></label>
                            <div class="btn-group btn-select-dropdown">
                                ...
                                <ul class="dropdown-menu w-100">
                                    <li><a class="dropdown-item small" href="#" data-value="1">All Type</a></li>

                                    <li><a class="dropdown-item small" href="#" data-value="2">Apartments</a></li>

                                    <li><a class="dropdown-item small" href="#" data-value="3">Bungalow</a></li>
                                ...
                                <select id="searchbox-2searchType" class="d-none">
                        ...
                        <div class="d-flex position-relative flex-column">
                            <button class="btn btn-primary d-block fw-bold" type="submit">Search</button>
                        </div>
                    </div>
                    <!-- /.position-relative -->
                    ...
                    <div class="position-absolute w-100 px-4">
                        ...
                        <div class="collapse" id="searchbox-2FormOptionsCollapse">
                            <div class="position-relative pt-3">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-auto d-flex align-items-center">
                                        <h6 class="my-0 fs-sm my-0 text-secondary">Filters</h6>
                                    </div>
                                    <div class="col d-flex align-items-center">
                                        <hr class="my-0 w-100" />
                                    </div>
                                ...
                                <div class="row g-4 mb-4">
                                        ...
                                        <div class="row g-3 position-relative">
                                            <div class="col">
                                                <div class="btn-group btn-range w-100 dropdown">
                                                    <button type="button"
                                                        ...
                                                        data-bs-toggle="dropdown" aria-expanded="false">250000</button>
                                                    <div class="dropdown-menu w-100 px-3 pt-2 pb-1 shadow-sm"
                                                        data-bs-popper="none">
                                                        <input type="range" name="Price[min]" min="250000" max="3000000"
                                                            step="250000" class="form-range"
                                                            data-range-max="#searchbox-2PriceMax" value="0"
                                                            id="searchbox-2PriceMin" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- /.col -->
                                            ...
                                            <div class="col-6">
                                                <div class="btn-group btn-range w-100 dropdown">
                                                    <button type="button"
                                                        class="btn btn-outline-primary btn-default dropdown-toggle d-flex align-items-center justify-content-between shadow-none allow-hover active"
                                                        data-bs-toggle="dropdown" aria-expanded="false">2000000</button>

                                                    <div class="dropdown-menu dropdown-menu-end w-100 px-3 pt-2 pb-1 shadow-sm"
                                                        data-bs-popper="none">
                                                        <input type="range" name="Price[max]" min="1000000"
                                                            max="4000000" step="250000" class="form-range"
                                                            value="2000000" data-range-min="#searchbox-2PriceMin"
                                                            id="searchbox-2PriceMax" />
                                                    </div>
                                            ...
                                            <div class="col pt-2">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="searchbox-2BedroomsAny" name="BedroomsAny" value="true"
                                                        checked="checked" />
                                                    <label class="form-check-label"
                                                        for="searchbox-2BedroomsAny">Any</label>
                                                </div>
                                            </div>
                                            <!-- /.col pt-2 -->
                                            ...
                                            <div class="col">
                                                <div class="btn-group btn-range w-100 dropdown">
                                                    <button type="button"
                                                        ...
                                                        data-bs-toggle="dropdown" aria-expanded="false">0</button>
                                                    <div class="dropdown-menu dropdown-menu-end w-75 px-3 pt-2 pb-1 shadow-sm"
                                                        data-bs-popper="none">
                                                        <input type="range" min="0" max="10" step="1" class="form-range"
                                                            name="Bedrooms" value="0" data-suffix="+"
                                                            id="searchbox-2Bedrooms" />
                                                    </div>
                                                </div>
                                                <!-- /.btn-group btn-range w-100 position-initial -->
                                            </div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <div class="row position-relative g-0" data-check-range>
                                            <div class="col pt-2">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="searchbox-2BathroomsAny" name="BathroomsAny" value="true"
                                                        checked="checked" />
                                                    <label class="form-check-label"
                                                        for="searchbox-2BathroomsAny">Any</label>
                                                </div>
                                            </div>
                                            <!-- /.col pt-2 -->
                                            ...
                                            <div class="col">
                                                <div class="btn-group btn-range w-100 dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end w-75 px-3 pt-2 pb-1 shadow-sm"
                                                        data-bs-popper="none">
                                                        <input type="range" min="0" max="10" step="1" class="form-range"
                                                            name="Bathrooms" value="0" data-suffix="+"
                                                            id="searchbox-2Bathrooms" />
                                                    </div>
                                                </div>
                                                <!-- /.btn-group btn-range w-100 position-initial -->
                                            </div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <label for="GarageAny" class="form-label fw-bold fs-sm mt-1 mb-0">Garage</label>
                                        <div class="row position-relative g-0" data-check-range>
                                            <div class="col pt-2">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="searchbox-2GarageAny" name="GarageAny" value="true"
                                                        checked="checked" />
                                                    <label class="form-check-label"
                                                        for="searchbox-2GarageAny">Any</label>
                                                </div>
                                            </div>
                                            <!-- /.col pt-2 -->
                                            ...
                                            <div class="col">
                                                <div class="btn-group btn-range w-100 dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end w-75 px-3 pt-2 pb-1 shadow-sm"
                                                        data-bs-popper="none">
                                                        <input type="range" min="0" max="10" step="1" class="form-range"
                                                            name="Garage" value="0" data-suffix="+"
                                                            id="searchbox-2Garage" />
                                                    </div>
                                                </div>
                                                <!-- /.btn-group btn-range w-100 position-initial -->
                                            </div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <div class="row position-relative g-0" data-check-range>
                                            <div class="col pt-2">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="searchbox-2StoriesAny" name="StoriesAny" value="true"
                                                        checked="checked" />
                                                    <label class="form-check-label"
                                                        for="searchbox-2StoriesAny">Any</label>
                                                </div>
                                            </div>
                                            <!-- /.col pt-2 -->
                                            ...
                                            <div class="col">
                                                <div class="btn-group btn-range w-100 dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end w-75 px-3 pt-2 pb-1 shadow-sm"
                                                        data-bs-popper="none">
                                                        <input type="range" min="0" max="10" step="1" class="form-range"
                                                            name="Stories" value="0" data-suffix="+"
                                                            id="searchbox-2Stories" />
                                                    </div>
                                                </div>
                                                <!-- /.btn-group btn-range w-100 position-initial -->
                                            </div>
                                ...
                                <div>
                                    ...
                                    <div class="row gx-4 gy-1 mb-4">
                                        <div class="col-12 col-sm-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" name="Amenities[AirConditioning]"
                                                    type="checkbox" id="AmenityAirConditioning" />
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-check form-switch">
                                                ...
                                                <label class="form-check-label" for="AmenityBasement">Basement</label>
                                            </div>
                                            <!-- /.form-check form-switch -->
                                        </div>
                                        <!-- /.col-12 col-sm-6 -->
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" name="Amenities[DisabilityFeatures]"
                                                    type="checkbox" id="AmenityDisabilityFeatures" />
                                                <label class="form-check-label"
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-check form-switch">
                                                ...
                                                <label class="form-check-label" for="AmenityCarport">Carport</label>
                                            </div>
                                            <!-- /.form-check form-switch -->
                                        </div>
                                        <!-- /.col-12 col-sm-6 -->
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" name="Amenities[Pool]" type="checkbox"
                                                    id="AmenityPool" />
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" name="Amenities[Built-InGasRange]"
                                                    type="checkbox" id="AmenityBuilt-InGasRange" />
                                                <label class="form-check-label" for="AmenityBuilt-InGasRange">Built-In
                                                    Gas Range</label>
                                            </div>
                                            <!-- /.form-check form-switch -->
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" name="Amenities[Pond]" type="checkbox"
                                                    id="AmenityPond" />
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-check form-switch">
                                                ...
                                                <label class="form-check-label" for="AmenitySpa/HotTube">Spa / Hot
                                                    Tube</label>
                                            </div>
                                            <!-- /.form-check form-switch -->
                                        </div>
                        ...
                        <div class="position-relative py-3">
                            <h6 class="fs-sm my-0">
                                <a class="text-center d-block collapsed text-secondary text-decoration-none"
                                    data-bs-toggle="collapse" href="#searchbox-2FormOptionsCollapse" role="button"
                                    aria-expanded="false" aria-controls="searchbox-2FormOptionsCollapse">
                                    <span class="form-is-not-focus">More Filter</span>
                                    <span class="form-is-focus">Hide Filter</span>
                                </a>
                            </h6>
                        </div>
                        <!-- /.position-relative -->
                    ...
                    <a class="searchbox-btn-close btn-close form-is-focus position-absolute top-0 start-100 translate-middle"
                        data-bs-toggle="collapse" href="#searchbox-2FormOptionsCollapse" role="button"
                        aria-expanded="false" aria-controls="searchbox-2FormOptionsCollapse"><span
    ...
    <!-- /.container-xl position-relative h-100 -->
</section>
...
<section id="listing-swiper-3-expand" class="section section__inverse py-5 py-lg-0">
    <div class="bg bg-img position-absolute w-lg-50 bg-primary" data-bg-img=".img"></div>
    <!-- /.bg bg-img position-absolute w-lg-50 bg-primary -->

    <div class="container-xl position-relative h-100">
        <div class="row">
            <div class="col-12 col-lg-4 d-flex py-4">
                <div class="position-relative py-4 pe-xl-5 d-flex flex-column justify-content-center">
                    <header class="section-header mb-4">
                        <h2 class="fs-3 section-title mb-3">Featured Properties</h2>

                        <p class="leadmb-0 o-75">Best properties handpicked professionally by our expert dolor sit amet
                            lorem ipsum</p>
                    </header>
                    <!-- /.section-header mb-4 -->

                    <p>
                        <button class="btn btn-light rounded-pill shadow-none me-2 px-4 fw-bold" data-bs-toggle="modal"
                            data-bs-target="#searchModal"><i class="fas fa-search text-primary"></i> Discover
                            More</button>
                    </p>
                </div>
                <!-- /.position-relative -->
            ...
            <div class="col-12 col-lg-8">
                <div class="swiper-container my-n4">
                    <div id="listing-swiper-3-expand-swiper" class="swiper expand-w" data-js-swiper="auto">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide w-330px">
                                <div class="row g-0">
                                    <div class="col-12">
                                        <div
                                            class="card shadow-sm shadow-hover trans-base zoom-bg-img o-hover-all rounded-0">
                                            <div class="card-img bg bg-img" data-bg-img=".img">
                                            ...
                                            <div class="card-img-overlay d-flex flex-column px-0">
                                                ...
                                                <div
                                                    class="card-peek overlay-bottom position-absolute bottom-0 mb-3 px-3 w-100">
                                                    <div class="card-peek-show">
                                                        <p
                                                            class="card-text mb-0 d-flex flex-row align-items-center w-100">
                                                            <a href="http://html.coolorize.com/discoverize/default/listing-detail-2.html"
                                                                class="fs-5 fw-bold trans-base text-white">$255,000</a>
                                                        </p>

                                                        <p class="card-text text-light mb-1 text-truncate mt-1">70
                                                            Sagamoga Hill Road, San Jose, NY 110000</p>

                                                        <p
                                                            class="row gx-0 gx-md-2 text-light mb-2 text-truncate d-block">
                                            ...
                                            <div class="card-img-overlay d-flex flex-column px-0">
                                                ...
                                                <div
                                                    ...
                                                    <div class="card-peek-show">
                                                        ...
                                                        <p class="card-text text-light mb-1 text-truncate mt-1">878
                                                            Auburn City, Port Washington, CA 110000</p>
                                            ...
                                            <div class="card-img-overlay d-flex flex-column px-0">
                                                ...
                                                <div
                                                    ...
                                                    <div class="card-peek-show">
                                                        ...
                                                        <p class="card-text text-light mb-1 text-truncate mt-1">456 Park
                                                            Avenue, 256A, Westlake, NY 110000</p>
                                            ...
                                            <div class="card-img-overlay d-flex flex-column px-0">
                                                ...
                                                <div
                                                    ...
                                                    <div class="card-peek-show">
                                                        ...
                                                        <p class="card-text text-light mb-1 text-truncate mt-1">283
                                                            Travus High, San Jose, TX 110000</p>
                                            ...
                                            <div class="card-img-overlay d-flex flex-column px-0">
                                                ...
                                                <div
                                                    ...
                                                    <div class="card-peek-show">
                                                        ...
                                                        <p class="card-text text-light mb-1 text-truncate mt-1">30 Beach
                                            ...
                                            <div class="card-img-overlay d-flex flex-column px-0">
                                                ...
                                                <div
                                                    ...
                                                    <div class="card-peek-show">
                                                        ...
                                                        <p class="card-text text-light mb-1 text-truncate mt-1">70
                                                            Lambok Hill Road, Port Washington, NY 110000</p>
                                            ...
                                            <div class="card-img-overlay d-flex flex-column px-0">
                                                ...
                                                <div
                                                    ...
                                                    <div class="card-peek-show">
                                                        ...
                                                        <p class="card-text text-light mb-1 text-truncate mt-1">70
                                                            Mogajaya Hill Road, Port Washington, NY 110000</p>
                                            ...
                                            <div class="card-img-overlay d-flex flex-column px-0">
                                                ...
                                                <div
                                                    ...
                                                    <div class="card-peek-show">
                                                        ...
                                                        <p class="card-text text-light mb-1 text-truncate mt-1">40
                                                            Sunburn Hill Road, Port Washington, NY 110000</p>
                                            ...
                                            <div class="card-img-overlay d-flex flex-column px-0">
                                                ...
                                                <div
                                                    ...
                                                    <div class="card-peek-show">
                                                        ...
                                                        <p class="card-text text-light mb-1 text-truncate mt-1">50
                                                            Ground Hound Road, Port Washington, NY 110000</p>
                                ...
                                <div class="row g-0">
                                    <div class="col-12">
                                        <div
                                            class="card shadow-sm shadow-hover trans-base zoom-bg-img o-hover-all rounded-0">
                                            <div class="card-img bg bg-img" data-bg-img=".img">
                                                <img src="http://assets.coolorize.com/homes/5-3/lg/pexels-pixabay-221540.jpg"
                                                    class="img" alt="Image" />
                                                <div class="overlay bg-dark position-absolute o-25 o-50-hover"></div>
                                            </div>
                                            <!-- /.card-img bg bg-img -->
                                    ...
                                    <div class="col-12">
                                        <div
                                            class="card shadow-sm shadow-hover trans-base zoom-bg-img o-hover-all rounded-0">
                                            <div class="card-img bg bg-img" data-bg-img=".img">
                                                <img src="http://assets.coolorize.com/homes/5-3/lg/jacques-bopp-Hh18POSx5qk-unsplash.jpg"
                                                    class="img" alt="Image" />
                                                <div class="overlay bg-dark position-absolute o-25 o-50-hover"></div>
                                            </div>
                                            <!-- /.card-img bg bg-img -->
                                                ...
                                                <div
                                                    ...
                                                    <div class="card-peek-show">
                                                        <p
                                                            class="card-text mb-0 d-flex flex-row align-items-center w-100">
                                                            <a href="http://html.coolorize.com/discoverize/default/listing-detail-2.html"
                                                                class="fs-5 fw-bold trans-base text-white">$350,000</a>
                                                        </p>

                                                        <p class="card-text text-light mb-1 text-truncate mt-1">123
                                                            Brick Kiln Road, Brigeshington, CA 110000</p>
                                ...
                                <div class="row g-0">
                                    <div class="col-12">
                                        <div
                                            class="card shadow-sm shadow-hover trans-base zoom-bg-img o-hover-all rounded-0">
                                            <div class="card-img bg bg-img" data-bg-img=".img">
                                                <img src="http://assets.coolorize.com/homes/5-3/lg/pexels-scott-webb-1029599.jpg"
                                                    class="img" alt="Image" />
                                                <div class="overlay bg-dark position-absolute o-25 o-50-hover"></div>
                                            </div>
                                            <!-- /.card-img bg bg-img -->
                                    ...
                                    <div class="col-12">
                                        <div
                                            class="card shadow-sm shadow-hover trans-base zoom-bg-img o-hover-all rounded-0">
                                            <div class="card-img bg bg-img" data-bg-img=".img">
                                                <img src="http://assets.coolorize.com/homes/5-3/lg/milan-seitler-2WvijgM7uTo-unsplash.jpg"
                                                    class="img" alt="Image" />
                                                <div class="overlay bg-dark position-absolute o-25 o-50-hover"></div>
                                            </div>
                                            <!-- /.card-img bg bg-img -->
                                                ...
                                                <div
                                                    ...
                                                    <div class="card-peek-show">
                                                        <p
                                                            class="card-text mb-0 d-flex flex-row align-items-center w-100">
                                                            <a href="http://html.coolorize.com/discoverize/default/listing-detail-2.html"
                                                                class="fs-5 fw-bold trans-base text-white">$210,000</a>
                                                        </p>

                                                        <p class="card-text text-light mb-1 text-truncate mt-1">70 Great
                                                            Hill Road, Port Washington, NY 110000</p>
                            ...
                            <!-- /.swiper-slide w-330px -->
                        </div>
                        <!-- /.swiper-wrapper -->
                    </div>
                    <!-- /#listing-swiper-3-expand-swiper.swiper -->

                    <div class="swiper-navigation-container">
                        <a href="#listing-swiper-3-expand-swiper"
                            class="swiper-button-next btn btn-primary btn-default shadow-none o-50 o-100-hover"><i
                                class="d-inline-block fas fa-angle-right"></i></a>
                        <a href="#listing-swiper-3-expand-swiper"
                            class="swiper-button-prev btn btn-primary btn-default shadow-none o-50 o-100-hover"><i
...
<!-- #listing-swiper-3-expand.section section__inverse py-5 py-lg-0 -->
...
<section id="testimonials-swiper-3" class="section py-5 py-lg-6">
    <div class="bg bg-img position-absolute" data-bg-img=".img"></div>
    <!-- /.bg bg-img position-absolute -->
    ...
    <div class="container-xl position-relative">
        <div class="row">
            ...
            <div class="col-12 col-lg-8">
                <div class="swiper-container with-pagination">
                    <div id="testimonials-swiper-3-swiper" class="swiper" data-js-swiper="auto">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="swiper-slide-container">
                                    <div class="row testimonials g-4">
                                        <div class="col-6 col-md d-flex align-items-stretch">
                                            <figure class="card testimonial h-100 text-start bg-transparent mb-0">
                                                <blockquote
                                                    class="blockquote card-body bg-secondary shadow-sm rounded d-flex flex-column px-lg-5">
                                                    <p class="fs-1 text-light o-25 mb-0"><i
                                                            class="fas fa-quote-right"></i></p>
                                                    <p class="fs-6 text-white">Lorem ipsum, dolor sit amet consectetur,
                                                        adipisicing elit tenetur. Omnis unde totam minima hic in
                                                        mollitia</p>
                                                    <p class="text-light text-decoration-none fs-sm mt-auto mb-3 o-75">
                                                        &mdash;<span class="fw-bold"> John Doe</span> - IT Profesional
                                                    </p>
                                                    <div class="img px-3 px-lg-4">
                                                        <img src="http://assets.coolorize.com/avatar/256x256/ariel-lustre-368240.jpg"
                                                            class="img rounded-circle" alt="Image" />
                                        ...
                                        <div class="col-6 col-md d-flex align-items-stretch">
                                            <figure class="card testimonial h-100 text-start bg-transparent mb-0">
                                                <blockquote
                                                    ...
                                                    <p class="fs-1 text-light o-25 mb-0"><i
                                                            class="fas fa-quote-right"></i></p>
                                                    <p class="fs-6 text-white">Omnis unde totam consequatur minima hic
                                                        in mollitia lorem ipsum, dolor sit amet consectetur, adipisicing
                                                        elit</p>
                                                    <p class="text-light text-decoration-none fs-sm mt-auto mb-3 o-75">
                                                        &mdash;<span class="fw-bold"> John Doe</span> - Sales
                                                        Representative</p>
                                                    <div class="img px-3 px-lg-4">
                                                        <img src="http://assets.coolorize.com/avatar/256x256/ben-white-190081.jpg"
                                                            class="img rounded-circle" alt="Image" />
                                        ...
                                        <div class="col-6 col-md d-flex align-items-stretch">
                                            <figure class="card testimonial h-100 text-start bg-transparent mb-0">
                                                <blockquote
                                                    ...
                                                    <p class="fs-1 text-light o-25 mb-0"><i
                                                            class="fas fa-quote-right"></i></p>
                                                    <p class="fs-6 text-white">Veniam iste, vitae maiores. tenetur Quis
                                                        voluptates consequatur unde culpa perspiciatis odit vero beatae
                                                    </p>
                                                    <p class="text-light text-decoration-none fs-sm mt-auto mb-3 o-75">
                                                        &mdash;<span class="fw-bold"> John Doe</span> - Marketing
                                                        Manager</p>
                                                    <div class="img px-3 px-lg-4">
                                                        <img src="http://assets.coolorize.com/avatar/256x256/dmitriy-ilkevich-437760.jpg"
                                                            class="img rounded-circle" alt="Image" />
                                        ...
                                        <div class="col-6 col-md d-flex align-items-stretch">
                                            <figure class="card testimonial h-100 text-start bg-transparent mb-0">
                                                <blockquote
                                                    ...
                                                    <p class="fs-1 text-light o-25 mb-0"><i
                                                            class="fas fa-quote-right"></i></p>
                                                    <p class="fs-6 text-white">Explicabo facere maxime fuga voluptates
                                                        saepe veniam iste, vitae maiores. Quis voluptates consequatur
                                                    </p>
                                                    <p class="text-light text-decoration-none fs-sm mt-auto mb-3 o-75">
                                                        &mdash;<span class="fw-bold"> John Doe</span> - General Manager
                                                    </p>
                                                    <div class="img px-3 px-lg-4">
                                                        <img src="http://assets.coolorize.com/avatar/256x256/melissa-mjoen-385845.jpg"
                                                            class="img rounded-circle" alt="Image" />
                                        ...
                                        <div class="col-6 col-md d-flex align-items-stretch">
                                            <figure class="card testimonial h-100 text-start bg-transparent mb-0">
                                                <blockquote
                                                    ...
                                                    <p class="fs-1 text-light o-25 mb-0"><i
                                                            class="fas fa-quote-right"></i></p>
                                                    <p class="fs-6 text-white">Unde culpa perspiciatis odit vero beatae
                                                        tenetur facere tenetur dolor sit amet consectetur adipisicing
                                                    </p>
                                                    <p class="text-light text-decoration-none fs-sm mt-auto mb-3 o-75">
                                                        &mdash;<span class="fw-bold"> John Doe</span> - Freelancer</p>
                                                    <div class="img px-3 px-lg-4">
                                            ...
                                            <figure class="card testimonial h-100 text-start bg-transparent mb-0">
                                                <blockquote
                                                    ...
                                                    <p class="fs-1 text-light o-25 mb-0"><i
                                                            class="fas fa-quote-right"></i></p>
                                                    <p class="fs-6 text-white">Explicabo facere maxime fuga voluptates
                                                        saepe tenetur veniam iste, vitae maiores. Quis voluptates unde
                                                        culpa</p>
                                                    <p class="text-light text-decoration-none fs-sm mt-auto mb-3 o-75">
                                                        &mdash;<span class="fw-bold"> John Doe</span> - Software
                                                        Deveoloper</p>
                                                    <div class="img px-3 px-lg-4">
                                                        <img src="http://assets.coolorize.com/avatar/256x256/photo-1423483786645-576de98dcbed.jpg"
                                                            class="img rounded-circle" alt="Image" />
                                        ...
                                        <div class="col-6 col-md d-flex align-items-stretch">
                                            <figure class="card testimonial h-100 text-start bg-transparent mb-0">
                                                <blockquote
                                                    ...
                                                    <p class="fs-1 text-light o-25 mb-0"><i
                                                            class="fas fa-quote-right"></i></p>
                                                    <p class="fs-6 text-white">Maxime fuga voluptates saepe veniam iste,
                                                        vitae maiores. Quis maxime voluptates consequatur unde culpa
                                                        beatae</p>
                                                    <p class="text-light text-decoration-none fs-sm mt-auto mb-3 o-75">
                                                        &mdash;<span class="fw-bold"> John Doe</span> - Designer</p>
                                                    <div class="img px-3 px-lg-4">
                                        ...
                                        <div class="col-6 col-md d-flex align-items-stretch">
                                            <figure class="card testimonial h-100 text-start bg-transparent mb-0">
                                                <blockquote
                                                    ...
                                                    <p class="fs-1 text-light o-25 mb-0"><i
                                                            class="fas fa-quote-right"></i></p>
                                                    <p class="fs-6 text-white">Perspiciatis odit vero beatae tenetur
                                                        facere dolor sit amet consectetur voluptates adipisicing elit
                                                        animi</p>
                                                    <p class="text-light text-decoration-none fs-sm mt-auto mb-3 o-75">
                                                        &mdash;<span class="fw-bold"> John Doe</span> - Sales Manager
                                                    </p>
                                                    <div class="img px-3 px-lg-4">
                                                        <img src="http://assets.coolorize.com/avatar/256x256/photo-1429114753120-0733a750d6c1.jpg"
                                                            class="img rounded-circle" alt="Image" />
                                        ...
                                        <div class="col-6 col-md d-flex align-items-stretch">
                                            <figure class="card testimonial h-100 text-start bg-transparent mb-0">
                                                <blockquote
                                                    ...
                                                    <p class="fs-1 text-light o-25 mb-0"><i
                                                            class="fas fa-quote-right"></i></p>
                                                    <p class="fs-6 text-white">Facere maxime fuga voluptates saepe
                                                        veniam iste, Veniam beatae vitae maiores. Quis voluptates
                                                        perspiciatis odit</p>
                                                    <p class="text-light text-decoration-none fs-sm mt-auto mb-3 o-75">
                                                        &mdash;<span class="fw-bold"> John Doe</span> - Country Manager
                                                    </p>
                                                    <div class="img px-3 px-lg-4">
                                                        <img src="http://assets.coolorize.com/avatar/256x256/photo-1443381301867-5a36ffaafc42.jpg"
                                                            class="img rounded-circle" alt="Image" />
                    ...
                    <!-- /#testimonials-swiper-3-swiper.swiper -->

                    <div class="swiper-navigation-container">
                        <a href="#testimonials-swiper-3-swiper"
                            class="swiper-button-next btn btn-primary btn-default shadow-none o-50 o-100-hover"><i
                                class="d-inline-block fas fa-angle-right"></i></a>
                        <a href="#testimonials-swiper-3-swiper"
                            class="swiper-button-prev btn btn-primary btn-default shadow-none o-50 o-100-hover"><i
                    ...
                    <div class="swiper-pagination-container">
                        <div class="d-flex flex-row justify-content-start">
                            <div data-swiper-id="#testimonials-swiper-3-swiper"
                                class="swiper-pagination w-auto bottom-0" data-swiper-pagination-limit="2"></div>

                            <a href="http://html.coolorize.com/discoverize/default/testimonials-1.html"
                                class="btn btn-link btn-sm btn-more text-uppercase fw-bold shadow-none o-50 o-100-hover ms-3 trans-base px-0">More
                                Testimonials<i class="fas fa-long-arrow-alt-right"></i></a>
                        </div>
                    </div>
                </div>
...
<!-- #testimonials-swiper-3.section py-5 py-lg-6 -->

<section id="news-3" class="section py-5 py-lg-6">
    ...
    <div class="container-xl position-relative">
        <div class="row gx-5">
            <div class="col-12 col-lg-4 col-xl-4">
                <header class="section-header mb-4">
                    <h2 class="fs-3 section-title mb-3">News and Insight</h2>

                    <p class="leadmb-0 o-75">Quasi deleniti aliquam ab reprehenderit tempore inventore esse est veniam
                        unde</p>
                </header>
                <!-- /.section-header mb-4 -->

                <p>
                    <a href="http://html.coolorize.com/discoverize/default/blog-1.html"><span
                            class="btn btn-sm btn-outline-primary btn-default">News</span></a>
                    <a href="http://html.coolorize.com/discoverize/default/blog-1.html"><span
                            class="btn btn-sm btn-outline-primary btn-default">Insights</span></a>
                    <a href="http://html.coolorize.com/discoverize/default/blog-1.html"><span
                            class="btn btn-sm btn-outline-primary btn-default">Review</span></a>
                    <a href="http://html.coolorize.com/discoverize/default/blog-1.html"><span
                            class="btn btn-sm btn-outline-primary btn-default">Tips</span></a>
                </p>
            </div>
            <!-- /.col-12 col-lg-4 col-xl-4 -->
            ...
            <div class="col-12 col-lg-8 col-xl-8">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card card__minimal h-100">
                            <div class="card-img-top overflow-hidden position-relative">
                                <img src="http://assets.coolorize.com/5-3/lg/photo-1444426724550-c7bfccd051ee.jpg"
                                    class="w-100" alt="Image" />
                            </div>
                            <div class="card-body pt-3">
                                <h3 class="fs-5"><a
                                        href="http://html.coolorize.com/discoverize/default/blog-post-1.html"
                                        class="stretched-link">Landscape Designers Will always Be Key to the Future of
                                        Our Cities</a></h3>
                                <p class="fs-sm text-secondary">The title says it all isnt it, if you dont get it read
                                    it again</p>
                            </div>
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                <div class="card bg-transparent">
                                    <div class="row">
                                        <div class="col-3">
                                            <img src="http://assets.coolorize.com/4-3/xs/reserve-NnDHkyxLTFe7d5UZv9Bk_louvre.jpg"
                                        ...
                                        <div class="col-9 d-flex flex-column">
                                            <div class="card-body p-0">
                                                <h3 class="fs-6"><a
                                                        href="http://html.coolorize.com/discoverize/default/blog-post-1.html"
                                                        class="">Breathtakingly Buildings Photo collections from around
                                                        the world</a></h3>
                                            </div>
                                            <div class="card-footer mt-auto p-0 bg-transparent fs-sm"><span
                                                    class="o-50">By</span> <a href=""
                                                    class="fw-bold o-50 o-100-hover trans-base position-relative zi-20">John
                                                    Doe</a> <span class="o-50">in</span> <a href=""
                                                    class="fw-bold o-50 o-100-hover trans-base position-relative zi-20">News</a>
                                            </div>
                                        </div>
                                        <!-- /.col-9 -->
                            ...
                            <div class="col-12">
                                <div class="card bg-transparent">
                                    <div class="row">
                                        <div class="col-3">
                                            <img src="http://assets.coolorize.com/4-3/xs/christian-joudrey-98245.jpg"
                                                class="w-100 rounded" alt="Image" />
                                        </div>
                                        <!-- /.col-3 -->
                                        ...
                                        <div class="col-9 d-flex flex-column">
                                            <div class="card-body p-0">
                                                <h3 class="fs-6"><a
                                                        href="http://html.coolorize.com/discoverize/default/blog-post-1.html"
                                                        class="">Backpacking in Japan - Travel on any Budget, any
                                                        Destination</a></h3>
                                            </div>
                                            <div class="card-footer mt-auto p-0 bg-transparent fs-sm"><span
                                                    class="o-50">By</span> <a href=""
                            ...
                            <div class="col-12">
                                <div class="card bg-transparent">
                                    <div class="row">
                                        <div class="col-3">
                                            <img src="http://assets.coolorize.com/4-3/xs/photo-1431578409060-9aad91ba5f79.jpg"
                                                class="w-100 rounded" alt="Image" />
                                        </div>
                                        <!-- /.col-3 -->
                                        ...
                                        <div class="col-9 d-flex flex-column">
                                            <div class="card-body p-0">
                                                <h3 class="fs-6"><a
                                                        href="http://html.coolorize.com/discoverize/default/blog-post-1.html"
                                                        class="">Take only memories, leave only footprints - Chief
                                                        Seattle</a></h3>
                                            </div>
                                            <div class="card-footer mt-auto p-0 bg-transparent fs-sm"><span
                                                    class="o-50">By</span> <a href=""
                            ...
                            <div class="col-12">
                                <div class="card bg-transparent">
                                    <div class="row">
                                        <div class="col-3">
                                            <img src="http://assets.coolorize.com/4-3/xs/photo-1448518184296-a22facb4446f.jpg"
                                                class="w-100 rounded" alt="Image" />
                                        </div>
                                        <!-- /.col-3 -->
                                        ...
                                        <div class="col-9 d-flex flex-column">
                                            <div class="card-body p-0">
                                                <h3 class="fs-6"><a
                                                        href="http://html.coolorize.com/discoverize/default/blog-post-1.html"
                                                        class="">How to create amazing memories while traveling Around
                                                        the World</a></h3>
                                            </div>
                                            <div class="card-footer mt-auto p-0 bg-transparent fs-sm"><span
                                                    class="o-50">By</span> <a href=""
                ...
                <footer class="section-footer d-flex justify-content-start">
                    <p class="mb-0">
                        <a href="http://html.coolorize.com/discoverize/default/blog-post-1.html"
                            class="btn btn-link btn-sm btn-more text-uppercase fw-bold shadow-none o-50 o-100-hover trans-base px-0">All
                            News<i class="fas fa-long-arrow-alt-right"></i></a>
                    </p>
                </footer>
                <!-- /.section-footer d-flex justify-content-start -->
            </div>
            <!-- /.col-12 col-lg-8 col-xl-8 -->
        </div>
        <!-- /.row -->
...
<!-- #news-3.section py-5 py-lg-6 -->

<section id="callout-sell-1" class="section section__inverse py-0">
    <div class="bg bg-img position-absolute bg-primary" data-bg-img=".img"></div>
    <!-- /.bg bg-img position-absolute bg-primary -->
    ...
    <div class="container-xl position-relative">
        <div class="row">
            <div
                class="col-12 col-lg-6 col-xl-6 py-4 py-lg-7 pe-lg-6 d-flex flex-column justify-content-center section-content">
                <h2 class="fs-1 mb-3 text-white">Thinking of Selling Your House?</h2>
                <p class="lead mb-4">We buy your home in your terms. Get an instant offer and options within 24 hours or
                    you can easily lists with us.</p>

                <form action="http://html.coolorize.com/discoverize/default/page-sell-1.html" method="post" class="">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control form-control-lg" placeholder="Your Home Address"
                            aria-label="Recipient's username" aria-describedby="button-addon2" />
                        <button class="btn btn-warning btn-lg px-4" type="button" id="button-addon2">Submit</button>
            ...
            <div class="col-12 col-lg-6 col-xl-6">
                <div class="position-relative expand-w h-100 o-75">
                    <div class="bg bg-img position-absolute" data-bg-img=".img">
                        <img src="http://assets.coolorize.com/homes/5-3/xl/pexels-matthis-volquardsen-2326926.jpg"
                            class="img" alt="Image" />
                        <div class="overlay bg-dark position-absolute o-25"></div>
                    </div>
                    <!-- /.bg bg-img position-absolute -->
...
<footer class="bg-dark">
        ...
        <div class="container-xl position-relative">
            <div class="row gy-4 gx-4 section-content">
                <div class="col-12 col-lg-3 col-xl-4 pe-lg-4 pe-xl-5 d-flex flex-column flex-sm-row flex-lg-column">
                    ...
                    <p class="mb-1 w-sm-50 w-md-75 w-lg-100 ps-sm-2 ps-lg-0">We help you sell and buy properties
                        consectetur adipisicing, elit. Ullam distinctio, ex eveniet labore quidem incidunt nihil hic
                        veritatis recusandae molestiae eaque unde quasi.</p>
                </div>
    ...
    <!-- #footer-bottom-1.section section__inverse py-3 -->
</footer>

<div class="modal modal-searchbox fade" id="searchModal" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body p-0">
                <div id="Searchbox" class="searchbox position-relative">
                    <a class="form-options-backdrop modal-backdrop collapsed" data-bs-toggle="collapse"
                        href="#FormOptionsCollapse" role="button" aria-expanded="false"
                        aria-controls="FormOptionsCollapse"></a>
                    <form action="http://html.coolorize.com/discoverize/default/listing-search-header.html"
                        class="searchbox-form position-relative w-100">
                        <div class="bg position-absolute bg-white rounded-top shadow-sm"></div>
                        <div class="position-relative pt-4 px-4">
                            <h1 class="fs-3 mb-2 position-relative">Discover Your Dream House</h1>
                            ...
                            <div class="mb-3 position-relative">
                                <input type="text" class="form-control form-control shadow-none py-2"
                                    placeholder="Address, Country, City or Postal Code"
                                    data-show-bs-collapse-id="#FormOptionsCollapse" data-scroll-to="#searchBox" />
                            </div>
                            <!-- /.mb-3 position-relative -->
                            ...
                            <div class="mb-3 position-relative d-flex flex-column">
                                <label class="form-label text-secondary my-1"><small>Property Category</small></label>
                                <div class="btn-group" role="group">
                                    <input type="radio" class="btn-check" name="searchCategory" id="searchCategory_sell"
                                        checked />
                                    <label class="btn btn-outline-primary btn-default shadow-none fw-bold"
                                        for="searchCategory_sell"><i class="fas fa-check"></i>For&nbsp;Sale</label>
                                    <input type="radio" class="btn-check" name="searchCategory"
                                        id="searchCategory_rent" />
                                    <label class="btn btn-outline-primary btn-default shadow-none fw-bold"
                                        for="searchCategory_rent"><i class="fas fa-check"></i>For&nbsp;Rent</label>
                                </div>
                                <!-- /.btn-group -->
                            </div>
                            <!-- /.mb-3 position-relative -->
                        ...
                        <div class="position-absolute w-100 px-4">
                            ...
                            <div class="collapse" id="FormOptionsCollapse">
                                <div class="position-relative pt-3">
                                    <div class="row mb-3">
                                        <div class="col d-flex align-items-center">
                                            <hr class="my-0 w-100" />
                                    ...
                                    <div class="row g-4 mb-4">
                                                    ...
                                                    <div class="btn-group btn-range w-100 dropdown">
                                                        ...
                                                        <div class="dropdown-menu w-100 px-3 pt-2 pb-1 shadow-sm"
                                                            ...
                                                            <input type="range" name="Price[min]" min="250000"
                                                                ...
                                                                data-range-max="#PriceMax" value="0" id="PriceMin" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- /.col -->
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <div class="row position-relative g-0" data-check-range>
                                                <div class="col pt-2">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="BedroomsAny"
                                                            name="BedroomsAny" value="true" checked="checked" />
                                                        <label class="form-check-label" for="BedroomsAny">Any</label>
                                                    </div>
                                                </div>
                                                <!-- /.col pt-2 -->
                                                ...
                                                <div class="col pt-2">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            checked="checked" />
                                                        <label class="form-check-label" for="BathroomsAny">Any</label>
                                                    </div>
                                                </div>
                                                <!-- /.col pt-2 -->
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <div class="row position-relative g-0" data-check-range>
                                                <div class="col pt-2">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="GarageAny"
                                                            name="GarageAny" value="true" checked="checked" />
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <div class="row position-relative g-0" data-check-range>
                                                <div class="col pt-2">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="StoriesAny"
                                                            name="StoriesAny" value="true" checked="checked" />
                            ...
                            <div class="position-relative py-3">
                                <h6 class="fs-sm my-0">
                                    <a class="text-center d-block collapsed text-secondary text-decoration-none"
                                        ...
                                        aria-expanded="false" aria-controls="FormOptionsCollapse">
                                        <span class="form-is-not-focus">More Filter</span>
                                        <span class="form-is-focus">Hide Filter</span>
                                    </a>
                                </h6>
                        ...
                        <a class="searchbox-btn-close btn-close form-is-focus position-absolute top-0 start-100 translate-middle"
                            data-bs-toggle="collapse" href="#FormOptionsCollapse" role="button" aria-expanded="false"
                            aria-controls="FormOptionsCollapse"><span class="btn-close-icon"></span></a>
                    </form>
                    <!-- /.searchbox-form -->
                </div>
                <!-- /#Searchbox.searchbox -->
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <form action="http://html.coolorize.com/discoverize/default/#" method="post">
                    <h6 class="mb-4">Welcome back</h6>

                    <div class="mb-3">
                        <label for="userSignInEmail" class="form-label fs-sm fw-bold">Email</label>
                        <input type="email" class="form-control shadow-none" id="userSignInEmail" />
                    </div>

                    <div class="mb-3">
                        <label for="userSignInPassword" class="form-label fs-sm fw-bold">Password</label>
                        <input type="password" class="form-control shadow-none" id="userSignInPassword" />
                    </div>

                    <div class="mb-3">
                        <button type="submit" class="btn btn-primary w-100 text-uppercase fw-bold">Sign In</button>
                    </div>
                </form>

                <div class="text-center text-secondary fs-sm">
                    <p class="mb-1">
                        <a href="#" class="text-decoration-underline" data-bs-dismiss="modal" data-bs-toggle="modal"
                            data-bs-target="#userForgotModal">Forgot Password</a>
                    </p>
                    <p class="mb-0">New to Discoverize <a href="#" class="text-decoration-underline"
                            data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#userSignupModal">Create an
                            account</a></p>
                </div>
                <!-- /.text-center -->
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                ...
                <form action="http://html.coolorize.com/discoverize/default/#" method="post">
                    <div class="row gx-2">
                        <div class="col-12 col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control shadow-none" id="userSignupFirstName" />
                            </div>
                        </div>
                        <!-- /.col-12 -->
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control shadow-none" id="userSignupLastName" />
                            </div>
                        </div>
                        <!-- /.col-12 -->
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="userSignupEmail" class="form-label fs-sm fw-bold">Email</label>
                        <input type="email" class="form-control shadow-none" id="userSignupEmail" />
                    </div>

                    <div class="mb-3">
                        <label for="userSignUpPassword" class="form-label fs-sm fw-bold">Password</label>
                        <input type="password" class="form-control shadow-none" id="userSignUpPassword" />
                    </div>

                    <div class="mb-3">
                        <button type="submit" class="btn btn-primary w-100 text-uppercase fw-bold">Sign Up</button>
                    </div>
                </form>

                <div class="text-center text-secondary fs-sm">
                    <p class="mb-0">Already have an account? <a href="#" class="text-decoration-underline"
                            data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#userSignInModal">Sign In</a>
                    </p>
                </div>
                <!-- /.text-center -->
            </div>
